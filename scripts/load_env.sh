...
export WORKER_ALLOW_UNAUTHENTICATED="${WORKER_ALLOW_UNAUTHENTICATED:-true}"
export ORCH_ALLOW_UNAUTHENTICATED="${ORCH_ALLOW_UNAUTHENTICATED:-true}"
export WORKER_MIN_INSTANCES="${WORKER_MIN_INSTANCES:-0}"
export ORCH_MIN_INSTANCES="${ORCH_MIN_INSTANCES:-0}"
export WORKER_MAX_INSTANCES="${WORKER_MAX_INSTANCES:-20}"
export ORCH_MAX_INSTANCES="${ORCH_MAX_INSTANCES:-20}"
export WORKER_CONCURRENCY="${WORKER_CONCURRENCY:-80}"
export ORCH_CONCURRENCY="${ORCH_CONCURRENCY:-80}"
